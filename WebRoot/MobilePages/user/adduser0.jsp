...
<script type="text/javascript" src="js/layer.js"></script>
	<script type="text/javascript">
		...
		// function checkarrivalNumber() {
			// 	document.getElementById('default_arrive').style.display = "none";
			//
			//
			// }
			// function checkreturnNumber() {
			// 	document.getElementById('default_return').style.display = "none";
			// }
		//
		...
		<div id="webContainerBox" class="webContainerBox">
			<div id="webModuleContainer" class="webModuleContainer">
												...
												<form id="addUserForm" name="addUserForm" action="addUser.action"
													...
													<div class='g_globalLine '>
														<input type='text' maxlength='50' id='userName' name='userName'
															   class='mustItem itemEdit userAddItem g_input' placeholder='(必填)' onblur="search_userAgent(this)"
															   ><span
													...
													<div class='g_globalLine '>
														<input maxlength='11' minlength="11" type='hidden' name="userRole"
															   class='mustItem itemEdit userAddItem g_input' id='userRole' value="0" onblur="checkinfo(this)"
														>
													</div>
													<%--<div class='g_globalLine '>--%>
													...
													<div class='g_globalLine '>
														<select type='text' name="userAgent"
																class='mustItem itemEdit userAddItem g_input' id='userAgent'
																placeholder='(必选)' onclick="search_userAgent()" onblur="checkinfo(this)"
														>
															<%--<option value ="省级教育行政部门" style:display = "none"></option>--%>

															<%--<option value ="部署、合建高校" style:display = "none">部署、合建高校</option>--%>
															<%--<option value ="地方高校和民办高校代表主要负责同志" style:display = "none">地方高校和民办高校代表主要负责同志</option>--%>
				...
				<%--<div id="module415" class="form Handle  formStyle13" _autoheight="1"--%>
					<%--_height="0" _bheight="0" _intab="0" style="height: auto;">--%>
					<%--<div style="cursor:move;" _bannerautoheight="1" type='hidden'--%>
					...
					<%--<div class="formMiddle formMiddle415">--%>
						...
						<%--<div class="middleCenter middleCenter415">--%>
							...
							<%--</div>--%>
						<%--</div>--%>
						<%--&lt;%&ndash;<div class='signupSubmitCtrl g_globalLine'>&ndash;%&gt;--%>
							<%--&lt;%&ndash;<input type='button' style="cursor:pointer"&ndash;%&gt;--%>
								<%--&lt;%&ndash;class='g_button sendIcon signupSubmit submitIcon' id="button1"&ndash;%&gt;--%>
								<%--&lt;%&ndash;value='确认添加' onclick="addDevice();" />&ndash;%&gt;--%>
						<%--&lt;%&ndash;</div>&ndash;%&gt;--%>
	...
	<script>
		...
		function search_userAgent(x) {
			...
			$.ajax({
				...
				if (document.addUserForm.userAgent.options.length < 4) {
					document.addUserForm.userAgent.options[0] = new Option(value = "省级教育行政部门", "省级教育行政部门");
					document.addUserForm.userAgent.options[1] = new Option(value = "部属、合建高校", "部署、合建高校");
					document.addUserForm.userAgent.options[2] = new Option(value = "地方高校和民办高校", "地方高校和民办高校");
					document.addUserForm.userAgent.options[3] = new Option(value = "教指委");
					document.addUserForm.userAgent.options[4] = new Option(value = "京津冀列席代表", "京津冀列席代表");
				}
				if (data != null) {
					var listArr = [];
					var array = data.split("\r\n");
					...
					for (i = 0; i < counts; i++) {
						...
						if (array1[0] == userName) {
							...
							$("#userAgent").find("option:selected").text("");
							$("#userAgent").empty();
							document.addUserForm.userAgent.options[0] = new Option(value = array1[1], array1[1]);
							break;
						}
					}
