...
<div class="container">
    <div class="line bouncein">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <form id="loginForm" name="loginForm" action="addUser0Before.action" method="post">
            <div class="panel loginbox">
                ...
                <%--<c:choose>--%>
                    ...
                    <%--</c:when>--%>
                <%--</c:choose>--%>
                <div style="padding:30px;"><input type="button" onclick="location.href='addUser0Before.action'" class="button button-block bg-main text-big input-big" value="进入信息收集"></div>
