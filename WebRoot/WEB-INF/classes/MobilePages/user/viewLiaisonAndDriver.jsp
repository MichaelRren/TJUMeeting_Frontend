...
<body faiscoMobi="true" id="g_body" class="g_locale2052 mobiCol3">
	...
	<div id="g_web" class="g_web">
		...
		<div class='loginHeader webHeaderBg'>
			...
			<span class='title pageTitle'>联络员与司机信息查看</span>
		</div>
										...
										<div id='profileArea'>
											...
											<form id="viewForm" name="viewForm" action="/tianda">
												<div _bannerAutoHeight='1'
													...
													<div class='titleCenter titleCenter410'>
														<div class='titleText titleText410'>
															...
															<div class='textContent'>联络员信息</div>
														</div>
												...
												<div class='g_globalLine '>
													<input type='text' maxlength='50' id='liaisonName'
														class='mustItem itemEdit userAddItem g_input'
														readonly="readonly" value="${liaison.lname}"><span
														class='icon-liaisonNameIcon g_mainColor'></span><span
														class='mustIcon'>&nbsp;</span>
												</div>
												<div class='g_globalLine '>
													<input type='text'
														class='mustItem itemEdit userAddItem g_input' id='liaisonNumber'
														readonly="readonly" value="${liaison.lnumber}"><span
														class='icon-liaisonNumberIcon g_mainColor'></span><span
														class='mustIcon'>&nbsp;</span>
												</div>
												<div _bannerAutoHeight='1'
													 class='formBannerTitle formBannerTitle410'>
													...
													<div class='titleCenter titleCenter410'>
														<div class='titleText titleText410'>
															<div class='titleTextIcon icon-titleText'>&nbsp;</div>
															<div class='textContent'>司机信息</div>
														</div>
														<div class='formBannerMore formBannerMore410'></div>
													</div>
													<div class='titleRight titleRight410'></div>
												...
												<div class='g_globalLine '>
													<input type='text'
														class='mustItem itemEdit userAddItem g_input' id='driverName'
														readonly="readonly" value="${driver.dname}"><span
														class='icon-driverNameIcon g_mainColor'></span><span
														class='mustIcon'>&nbsp;</span>
												</div>
												<div class='g_globalLine '>
													<input type='text' maxlength='50' id='driverNumber'
														class='mustItem itemEdit userAddItem g_input'
														readonly="readonly" value="${driver.dnumber}"><span
														class='icon-driverNumberIcon g_mainColor'></span><span
														class='mustIcon'>&nbsp;</span>
												</div>
												<div class='g_globalLine '>
													<input type='text' maxlength='50' id='driverPlate'
														class='mustItem itemEdit userAddItem g_input'
														readonly="readonly" value="${driver.dplate}"><span
														class='icon-driverPlateIcon g_mainColor'></span><span
														class='mustIcon'>&nbsp;</span>
												</div>
