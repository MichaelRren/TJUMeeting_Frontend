...
<script src="js/jquery.js"></script>
	...
	<div id="g_web" class="g_web">
		...
		<div class='loginHeader webHeaderBg'>
			<a href='attendlogoff.do'
			   class='g_close icon-gClose'></a>
			<span class='title pageTitle'>确认个人信息</span>
			<%--<img src="images/edit2.png" class="g_edit icon-gEdit" width="35"--%>
				 <%--style="cursor:pointer"--%>
				 <%--onclick="javascript:window.location.href='updateUserBefore.do?userNumber=${db.UserNumber}'">--%>
		</div>
									...
									<div class='signUpContent'>
										<div id='profileArea'>
											<form id="addUserForm" name="addUserForm"
												...
												<div class='g_globalLine '>
													<input type='text'
														class='mustItem itemEdit userAddItem g_input' id='userNumber' name="userNumber"
		...
		function attendcheck() {
			...
			$.post("attendCheck.do", {
				...
				if (data) {
					...
					document.getElementById("button1").value = "已签到";
				}
			})
		}
        function attend(){
