...
<div class="page-container">
	...
	<form action="addUser.action" method="post" class="form form-horizontal" id="addUserForm" name="addUserForm" enctype="multipart/form-data" style="padding-left: 35%">
		...
		<div class="row cl" style="text-align:center;">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<select type="text" class="input w50"  maxlength='50' placeholder="(必填)" id="userAgent" name="userAgent" onfocus="search_userAgent()" onblur="checkinfo(this)">
					<option value ="省级教育行政部门" ></option>
					<option value ="部署、合建高校" >部署、合建高校</option>
					<option value ="地方高校和民办高校" >地方高校和民办高校</option>
				</select>
		...
		<div class="row cl" style="text-align:center;">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="email" class="input w50" maxlength='50' placeholder="(必填)" id="email" name="email" onblur="checkinfo(this)">
		...
		<input type="hidden" value=0 id="userRole" name="userRole">
